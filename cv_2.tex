...
\section{EMPLOYMENT}
  ...
  \begin{itemize}
    \item {\sl Postdoc Research Associate (\href{https://cifellows2020.org/}{CIFellow}), Electrical and Computer Engineering Department }
...
\item {Young Investigators Lecturer} \hspace*\fill\hfill{Caltech, 2021}
...
\item{\textbf{Qi Lei}, Jason Lee, Alexandros G. Dimakis, Contantinos 
  ...
  Learning (MLsys), 2019} (covered by \href{https://www.nature.com/articles/d41586-019-01510-1}{Nature News} )   }
...
\begin{enumerate}
\item {Baihe Huang*, Kaixuan Huang*, Sham M. Kakade*, Jason D. Lee*, \textbf{Qi Lei}*, Runzhe Wang*, Jiaqi Yang*,  ``Optimal Gradient-based Algorithms for Non-concave Bandit Optimization", 	\textit{arxiv preprint} }

\item {Baihe Huang*, Kaixuan Huang*, Sham M. Kakade*, Jason D. Lee*, \textbf{Qi Lei}*, Runzhe Wang*, Jiaqi Yang*, ``Going Beyond Linear RL: Sample Efficient Neural Function Approximation", \textit{arxiv preprint} }

\item 	{ Kurtland Chua, \textbf{Qi Lei}, Jason D. Lee. ``How Fine-Tuning Allows for Effective Meta-Learning”, \textit{arxiv preprint} }
...
\section{TEACHING}
{\sl Department of Electrical and Computer Engineering, Princeton University} \hfill Fall 2020
\begin{itemize}
...
\section{SERVICE}
{\sl 2020:} Co-organizing Mathematical Data Science Reading Group, which is a weekly departmental seminar series on Machine Learning Theory in ECE, Princeton 

%{\sl 2021:} Serve as a mentor at the mentorship program of WiML-T (Women in Machine Learning Theory)

{\sl Conference Reviewer:} MLSys (19,20,Meta-reviewer'21), COLT (21), STOC (20), NeurIPS (16,17,18,19,20,21), ICML (18,19,20,21), ICLR (18,19,20,21), 
...
IT (16,17), and more
 ...
 \begin{enumerate}
 	\item{``Optimal Gradient-based Algorithms for Non-concave Bandit Optimization."}
