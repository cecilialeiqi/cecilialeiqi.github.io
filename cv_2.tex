...
\begin{enumerate}
	\item{Simon S. Du*, Wei Hu*, Sham M. Kakade*, Jason D. Lee*, \textbf{Qi Lei}*. ``Few-Shot Learning via Learning the Representation, Provably'', \textit{To appear at ICLR 2021} }
	\item{\textbf{Qi Lei}*, Sai Ganesh Nagarajan*, Ioannis Panageas*, Xiao Wang*. ``Last iterate convergence in no-regret learning: constrained min-max optimization for convex-concave landscapes'',\textit{To appear at AISTATS 2021}}
