...
\section{Research\\ Interests}
My research aims to bridge the theoretical and empirical boundary of modern machine learning algorithms, with a focus on distributionally robust algorithms, representation/transfer learning and large-scale optimization. 
...
\item{Yijun Dong, Hoang Phan, Xiang Pan, \textbf{Qi Lei}, ``Sketchy Moment Matching: Toward Fast and Provable Data Selection for Finetuning", \textit{to appear at NeurIPS 2024} }
	
\item{Qian Yu, Yining Wang, Baihe Huang, \textbf{Qi Lei}, Jason D Lee, ``Stochastic Zeroth-Order Optimization under Strongly Convexity and Lipschitz Hessian: Minimax Sample Complexity", \textit{to appear at NeurIPS 2024} }
