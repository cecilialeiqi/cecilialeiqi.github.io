...
\item{Jay Whang, Qi Lei, Alexandros G. Dimakis. ``Compressed Sensing with Invertible Generative Models and Dependent Noise'', \textit{To appear at NeurIPS Workshop on Deep Learning and Inverse Problems, 2020}  }
